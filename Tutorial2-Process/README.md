...
This tutorial is designed to help you get a better understanding of Process and make Programming Assignment 1 more managable. This doc is not a replacement of the tutorial2, but a supplement to it. 
...
### 1.c SIGCHLD: handle the signal when a child process terminates
